		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "App Title",
									"targetURL": "#syncc203plantfault-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"syncc203plantfault-display": {
								"semanticObject": "syncc203plantfault",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=sync.c203.plantfault",
									"url": sap.ui.require.toUrl("sync/c203/plantfault")
								}
							}
						}
					}
