		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "배송 현황",
									"targetURL": "#syncc203delivery-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"syncc203delivery-display": {
								"semanticObject": "syncc203delivery",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=sync.c203.delivery",
									"url": sap.ui.require.toUrl("sync/c203/delivery")
								}
							}
						}
					}
