		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "App Title",
									"targetURL": "#syncc203salesorder-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"syncc203salesorder-display": {
								"semanticObject": "syncc203salesorder",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=sync.c203.salesorder",
									"url": sap.ui.require.toUrl("sync/c203/salesorder")
								}
							}
						}
					}
