		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "주문 현황",
									"targetURL": "#syncc203orderlistlast-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"syncc203orderlistlast-display": {
								"semanticObject": "syncc203orderlistlast",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=sync.c203.orderlistlast",
									"url": sap.ui.require.toUrl("sync/c203/orderlistlast")
								}
							}
						}
					}
