		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "vendor_detail",
									"targetURL": "#b020315vendordetail-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"b020315vendordetail-display": {
								"semanticObject": "b020315vendordetail",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=b020315.vendordetail",
									"url": sap.ui.require.toUrl("b020315/vendordetail")
								}
							}
						}
					}
