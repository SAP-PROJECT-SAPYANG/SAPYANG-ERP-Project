		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "재고 관리",
									"targetURL": "#b03mminventminventm-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"b03mminventminventm-display": {
								"semanticObject": "b03mminventminventm",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=b03.mm.inventm.inventm",
									"url": sap.ui.require.toUrl("b03/mm/inventm/inventm")
								}
							}
						}
					}
