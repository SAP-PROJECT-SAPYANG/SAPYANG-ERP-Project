sap.ui.define([
    ...
    function (Controller, JSONModel, MessageToast,UIComponent, MessageBox, History, Filter,FilterOperator, Fragment, Dialog) {
        ...
        return Controller.extend("b03.mm.inventm.inventm.controller.View1", {
            onInit: function () {
                var oData = {
                    inventmStgcd : null,
                    inventmMatcd : null,
            ...
            onDialogPress : function () {
                ...
                if (!oDialog) {
                    Fragment.load({
                        id: oView.getId(),
                        name: "b03.mm.inventm.inventm.view.Dialog",
                        controller: this
            ...
            _setDialogModel: function() {
                ...
                oDialogModel.setProperty('/', {
                    ...
                    requestDate: new Date(       // 납품요청일
                        oToday.getFullYear(), oToday.getMonth() + 2, oToday.getDate()
                    ),            
