		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Newvendor",
									"targetURL": "#b0315MMnewvendor-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"b0315MMnewvendor-display": {
								"semanticObject": "b0315MMnewvendor",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=b0315MM.newvendor",
									"url": sap.ui.require.toUrl("b0315MM/newvendor")
								}
							}
						}
					}
